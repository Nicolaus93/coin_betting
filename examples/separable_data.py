...
from optimal_pytorch.coin_betting.torch import Recursive, ONSBet, Cocob, Scinol2, Regralizer
...
if __name__ == '__main__':
    ...
    algos = [ONSBet, Cocob, Regralizer, Scinol2, Recursive, partial(Recursive, inner=Cocob)]
    fig = plt.figure()
